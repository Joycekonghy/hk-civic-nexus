...
const trips=[
  ...
  ["03","Culture & Connections","West Kowloon","Examining how museums, public spaces and cultural exchange shape the city."],
  ["04","Sustainable City Field Study","Victoria Harbour","Investigating how urban choices affect communities and the environment."],
  ["05","Community Organisations","Hong Kong","Learning how local organisations plan projects and deliver public services."],
];
